...
namespace AWS.S3.Lambda.Tests
{
    public class SimpleS3FunctionTest
    {
        [Fact]
        public async Task TestS3EventLambdaFunction()
        {
            ...
            var bucketName = "lambda-AWS.S3.Lambda-".ToLower() + DateTime.Now.Ticks;
            var key = "text.txt";
            ...
            try
            {
                ...
                var function = new SimpleS3Function(s3Client);
