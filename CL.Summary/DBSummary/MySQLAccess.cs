...
{
    public class MySQLAccess : IDBCommon, IMySQLAccess
    {
        private MySqlConnection connect = null;
        private MySqlTransaction transaction = null;
        private MySqlCommand command = new MySqlCommand();
        private string connectionString;
        private List<MySqlParameter> oracleParameters = new List<MySqlParameter>();
        ...
        {
            MySqlParameter oraPara = new MySqlParameter();

            oraPara.ParameterName = paraName;
            oraPara.MySqlDbType = dbType;
            oraPara.Value = value;
